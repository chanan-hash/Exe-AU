 ...
 *  @author Kevin Wayne
 */
public final class StdDraw_Ex3 implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	...
	private static StdDraw_Ex3 std = new StdDraw_Ex3();
	...
	private static JMenuBar createMenuBar() {
		...
		menuItem1 = new JMenuItem("20x20");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("40x40");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("80x80");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("160x160");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		...
		menuBar.add(menu);
		menuItem1 = new JMenuItem("White");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("Black");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("Blue");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("Red");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("Yellow");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		...
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("Segment");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("Rect");
		menu.add(menuItem1);
		menuItem1.addActionListener(std);
		menuItem1 = new JMenuItem("Point");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		
		menu = new JMenu("Algo");
		menuBar.add(menu);
		menuItem1 = new JMenuItem("Fill");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("Gol");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("ShortestPath");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
	...
	private static Image getImage(String filename) {
		...
		if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
			URL url = StdDraw_Ex3.class.getResource(filename);
			if (url != null)
				icon = new ImageIcon(url);
		}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(ev.equals("Save")) {
		FileDialog chooser = new FileDialog(StdDraw_Ex3.frame, "Use a .png or .jpg extension", FileDialog.SAVE);
		chooser.setVisible(true);
		String filename = chooser.getFile();
		if (filename != null) {
			StdDraw_Ex3.save(chooser.getDirectory() + File.separator + chooser.getFile());
		}
		}
	...
	public void mousePressed(MouseEvent e) {
		synchronized (mouseLock) {
			mouseX = StdDraw_Ex3.userX(e.getX());
			mouseY = StdDraw_Ex3.userY(e.getY());
			isMousePressed = true;
			System.out.println("Mouse: "+mouseX+","+mouseY);
		//	Controller.mouseClicked(new Point2D(mouseX, mouseY));
	 ...
	 */
	public static void main(String[] args) {
		StdDraw_Ex3.square(0.2, 0.8, 0.1);
		StdDraw_Ex3.filledSquare(0.8, 0.8, 0.2);
		StdDraw_Ex3.circle(0.8, 0.2, 0.2);

		StdDraw_Ex3.setPenColor(StdDraw_Ex3.BOOK_RED);
		StdDraw_Ex3.setPenRadius(0.02);
		StdDraw_Ex3.arc(0.8, 0.2, 0.1, 200, 45);

		// draw a blue diamond
		StdDraw_Ex3.setPenRadius();
		StdDraw_Ex3.setPenColor(StdDraw_Ex3.BOOK_BLUE);
		double[] x = { 0.1, 0.2, 0.3, 0.2 };
		double[] y = { 0.2, 0.3, 0.2, 0.1 };
		StdDraw_Ex3.filledPolygon(x, y);

		// text
		StdDraw_Ex3.setPenColor(StdDraw_Ex3.BLACK);
		StdDraw_Ex3.text(0.2, 0.5, "black text");
		StdDraw_Ex3.setPenColor(StdDraw_Ex3.WHITE);
		StdDraw_Ex3.text(0.8, 0.8, "white text");
		
		StdDraw_Ex3.setPenColor(StdDraw_Ex3.BOOK_BLUE);
		StdDraw_Ex3.rectangle(0.5, 0.7, 0.2, 0.1);
		double[] xx = {0.2,0.4,0.5};
		double[] yy = {0.8,0.4,0.5};
		StdDraw_Ex3.filledPolygon(xx, yy);
		StdDraw_Ex3.ellipse(0.7, 0.5, 0.2, 0.1);
	}
